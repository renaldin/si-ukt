        ...
        <div class="card">
               ...
               <div class="d-flex flex-wrap align-items-center justify-content-between">
                  <div class="d-flex flex-wrap align-items-center">
                     ...
                     <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                        <h4 class="me-2 h4">{{$user->nama_mahasiswa}}</h4>
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <div class="mt-2">
               <h6 class="mb-1">Kelompok UKT:</h6>
               <p>
                @if ($user->id_kelompok_ukt === null)
                Anda belum melakukan proses penentuan UKT
                @else
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="new-user-info">
                    ...
                    @endif
                    <form action="/edit-profil-mahasiswa/{{$user->id_mahasiswa}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="form-label" for="nama_mahasiswa">Nama Lengkap</label>
                            <input type="text" class="form-control @error('nama_mahasiswa') is-invalid @enderror" id="nama_mahasiswa" name="nama_mahasiswa" value="{{$user->nama_mahasiswa}}" autofocus placeholder="Masukkan Nama Lengkap ">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" value="{{$user->nim}}" placeholder="Masukkan NIM ">
                            @error('nim')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>

                ...
                <div class="new-user-info">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="kriteria" id="kriteria" class="selectpicker form-control @error('nilai_kriteria') is-invalid @enderror" data-style="py-0" disabled >
...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                    <h4 class="card-title">Daftar Nilai Kriteria</h4>
                </div>
            </div>
            ...
            <div class="card-body px-0">
                ...
                <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                    ...
                    <tbody>
                        <?php $no = 1;?>
                        @foreach ($daftarNilaiKriteria as $item)
                        @if ($item->id_kriteria == $kriteria->id_kriteria)
                            <tr>
                                <td>{{$no++}}</td>
                                ...
                                <div class="flex align-items-center list-user-action">
                                    <a class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-placement="top" title="Edit Nilai Kriteria" data-original-title="Edit" href="/edit-nilai-kriteria/{{$item->id_nilai_kriteria}}">
                                    ...
                                    <button type="button" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#hapus{{$item->id_nilai_kriteria}}" data-placement="top" title="Hapus Nilai Kriteria" data-original-title="Delete">
                                        <span class="btn-inner">
...
@foreach ($daftarNilaiKriteria as $item)
<div class="modal fade" id="hapus{{$item->id_nilai_kriteria}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Hapus Nilai Kriteria</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Apakah Anda yakin akan hapus nilai kriteria <strong>{{$item->nilai_kriteria}}</strong>?</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Keluar</button>
                <a href="/hapus-nilai-kriteria/{{$item->id_nilai_kriteria}}" type="button" class="btn btn-danger">Hapus</a>
            </div>
        </div>
    </div>
</div>

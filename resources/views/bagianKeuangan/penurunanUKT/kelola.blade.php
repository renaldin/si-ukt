                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex align-items-center list-user-action">
                                    ...
                                    <button type="button" class="btn btn-sm btn-icon btn-success" data-toggle="tooltip" data-bs-toggle="modal" data-bs-target="#keputusan{{$item->id_penurunan_ukt}}" data-placement="top" title="Beri Keputusan" data-original-title="Beri keputusan">
...
<div class="modal fade" id="keputusan{{$item->id_penurunan_ukt}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Beri Keputusan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Silahkan beri keputusan untuk pengajuan penurunan UKT dari mahasiswa yang bernama <strong>{{$item->nama_mahasiswa}}</strong>!</p>
            </div>
            <div class="modal-footer">
                <a href="/tidak-setuju-penurunan/{{$item->id_penurunan_ukt}}" class="btn btn-danger">Tidak Setuju</a>
                <a href="/setuju-penurunan/{{$item->id_penurunan_ukt}}" class="btn btn-success">Setuju</a>
            </div>
        </div>
    </div>
</div>

...
class PenurunanUKT extends Controller
{
    ...
    public function edit($id_penangguhan_ukt)
    {
        ...
        $data = [
            ...
            'form'              => 'Edit',
            'user'              => $this->ModelMahasiswa->detail(Session()->get('id_mahasiswa')),
            'detail'            => $this->ModelPenurunanUKT->detail($id_penangguhan_ukt),
        ];
    ...
    public function riwayat()
    {
        ...
        $data = [
            ...
            'user'              => $this->ModelMahasiswa->detail(Session()->get('id_mahasiswa')),
            'dataPenangguhanUKT' => $this->ModelPenurunanUKT->dataPenangguhanUKTByMahasiswa(Session()->get('id_mahasiswa')),
        ];
    ...
    public function prosesHapus($id_penangguhan_ukt)
    {
        ...
        $this->ModelPenurunanUKT->hapus($id_penangguhan_ukt);
    ...
    public function kelolaPenangguhanUKT()
    {
        ...
        $data = [
            ...
            'dataPenangguhanUKT' => $this->ModelPenurunanUKT->dataPenangguhanUKT(),
        ];
